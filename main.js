...
const testOfMyPromiseAll = () => MyPromise.all([p1(), p2(), p3]);

const p4 = () =>
  new MyPromise((resolve) =>
    setTimeout(() => {
      resolve("promise all race test용 2초뒤 resolve");
    }, 2000)
  );
...
const p5 = () =>
  new MyPromise((resolve) =>
    setTimeout(() => {
      resolve("promise race test용 4초뒤 resolve");
    }, 4000)
  );
...
const myPromiseTestFunctions = [
  () => testOfMyPromise().then((value) => console.log(value)),
  () =>
    testOfMyPromiseAll()
